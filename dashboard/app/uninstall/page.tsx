...
export default function UninstallFeedbackPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col justify-between font-sans selection:bg-brand-600 selection:text-white">
      {/* Header */}
      <header className="w-full border-b border-white/[0.08] bg-zinc-950/80 backdrop-blur-xl py-4 px-6">
      ...
      <main className="max-w-xl w-full mx-auto px-4 py-12 flex-1 flex flex-col justify-center">
        {isSubmitted ? (
          <div className="p-8 rounded-2xl bg-zinc-900/60 border border-white/[0.08] backdrop-blur-xl text-center space-y-4">
          ...
          <div className="rounded-2xl bg-zinc-900/60 border border-white/[0.08] p-6 sm:p-8 backdrop-blur-xl space-y-6">
            <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                      ...
                      className={`text-left text-xs px-3 py-2.5 rounded-xl border transition-colors ${
                        selectedReason === r
                          ...
                          : 'bg-zinc-950/60 text-zinc-400 hover:bg-zinc-800/50 hover:text-zinc-200 border-white/[0.06]'
                      }`}
                    >
                      {r}
                    </button>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl bg-zinc-950/70 border border-white/[0.08] focus:border-brand-500 text-xs text-white placeholder-zinc-500 outline-none transition-colors duration-150"
                />
              </div>
      ...
      {/* Clean Footer */}
      <footer className="border-t border-white/[0.08] py-4 bg-zinc-950 text-center text-xs text-zinc-500">
