...
import { TopCreatorsWidget, CreatorCount } from '@/components/TopCreatorsWidget';
...
export const DomainSidebar: React.FC<DomainSidebarProps> = ({
  ...
  return (
    <aside className="w-full lg:w-56 flex-shrink-0 space-y-4">
      ...
      {/* Top Creators Widget (Top 5 + Pagination + Exclusion of Unknown) */}
      {creators.length > 0 && onSelectCreator && (
        <TopCreatorsWidget
          creators={creators}
